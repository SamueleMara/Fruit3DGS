...
def main():
    ...
    # model_dir = "/home/samuelemara/gaussian-splatting-seg/output/Lemons_good" 
    ...
    # ----------------------------------------------------
    # Optimize coherence threshold (Bayesian Optimization)
    # ----------------------------------------------------
    ...
    trained_gs_seg.save_clustered_ply(filtered_ply_path,
                                      cluster_ids=trained_gs_seg.instance_ids)
